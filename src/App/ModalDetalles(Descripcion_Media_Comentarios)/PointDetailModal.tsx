                ...
                {allVideos.length > 0 ? (
                  <div className="fs-video-grid">
                    {allVideos.map((vid, idx) => (
                      <div key={idx} className="video-card vintage-tv-wrapper">
                        <div className="vintage-tv-frame">
                          <div className="vintage-tv-screen-container">
                            <video src={vid.url} controls className="vintage-tv-video" />
                            <div className="vintage-tv-crt-overlay"></div>
                          </div>
